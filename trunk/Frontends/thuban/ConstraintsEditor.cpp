...
void ConstraintsEditorWindow::setupUi(QMainWindow* ugp3mainWindow)
{
	Ui_ConstraintsEditor::setupUi(ugp3mainWindow);
	this->mainWindow = ugp3mainWindow;
	...
	this->highlighter = new XmlHighlighter( this->textEdit->document() );
}

// save and preview constraints file (slot to be connected to a button)
void ConstraintsEditorWindow::previewConstraintsFile()
{
...
void ConstraintsEditorWindow::saveConstraintsFile()
{
	// get the file name
...
void ConstraintsEditorWindow::loadConstraintsFile()
{
	// get the file name
...
// inserting the destructor, just to avoid a warning message about an unused variable
ConstraintsEditorWindow::~ConstraintsEditorWindow()
{
