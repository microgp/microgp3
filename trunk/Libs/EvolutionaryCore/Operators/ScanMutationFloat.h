...
#ifndef HEADER_UGP3_CORE_SCANMUTATIONFLOATOPERATOR
#define HEADER_UGP3_CORE_SCANMUTATIONFLOATOPERATOR
...
namespace ugp3
{
	namespace core
	{
        /** The Scan Mutation Operator for Float Parameters. */
		class ScanMutationFloatOperator : public MutationOperator
		{
		public:
			ScanMutationFloatOperator();
    ...
    virtual Category getCategory() { return DEFAULT_OFF; }
                ...
                inline bool ScanMutationFloatOperator::hasParameters() const
                {
                  return false;
                }

                inline void ScanMutationFloatOperator::writeXml(std::ostream& output) const
                {}

                inline void ScanMutationFloatOperator::readXml(const xml::Element& element)
                {}
	}
}
