...
public:
	...
	*/
    void LoadFile( TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING ) throw(std::exception);
	...
	*/
	void LoadFile( const char * filename, FILE*, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
	bool SaveFile( FILE* ) const;

	#ifdef TIXML_USE_STL
	void LoadFile( const std::string& filename, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
		StringToBuffer f( filename );
        this->LoadFile( f.buffer, encoding );
	}
