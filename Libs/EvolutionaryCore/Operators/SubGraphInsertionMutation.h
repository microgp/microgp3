/***********************************************************************\
|                                                                       |
| SubGraphInsertionMutationOperator.h                                   |
|                                                                       |
...
#ifndef HEADER_UGP3_CORE_SUBBGRAPHINSERTIONMUTATIONOPERATOR
#define HEADER_UGP3_CORE_SUBBGRAPHINSERTIONMUTATIONOPERATOR
...
namespace ugp3
{
	namespace core
	{
        /** The SubGraph Insertion Mutation Operator. It adds one or more subGraphs. */
		class SubGraphInsertionMutationOperator : public MutationOperator
		{
		public:
			SubGraphInsertionMutationOperator();

			/** It generates new individuals. They are saved in outChildren. outChildren may be empty if
				operator is failed. If sigma is > 0.0, two or more subGraphs could be added, 
    ...
    virtual Category getCategory() { return DEFAULT_ON; }
                ...
                inline bool SubGraphInsertionMutationOperator::hasParameters() const
                {
                  return false;
                }

                inline void SubGraphInsertionMutationOperator::writeXml(std::ostream& output) const
                {}

                inline void SubGraphInsertionMutationOperator::readXml(const xml::Element& element)
                {}
	}
}
