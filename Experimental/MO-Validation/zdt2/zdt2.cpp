// Test function to validate multi-objective optimizaion, taken from Chase et al. A Benchmark Study of Multi-Objective Optimization Methods
...
int main(int argc, char* argv[])
{
	...
	float gValue = g(x);
	float objective2 = gValue * (1.0 - (x[0] / gValue) * (x[0] / gValue)); 
