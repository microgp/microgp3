...
namespace ugp3
{
	namespace core
	{
        /** The Swap Mutation Operator. It modifies a parameter of type CombinatorialParameter */
    ...
    virtual Category getCategory() { return DEFAULT_ON; }
                ...
                inline bool SwapMutationOperator::hasParameters() const
                {
                  return false;
                }

                inline void SwapMutationOperator::writeXml(std::ostream& output) const
                {}

                inline void SwapMutationOperator::readXml(const xml::Element& element)
                {}
	}
}
