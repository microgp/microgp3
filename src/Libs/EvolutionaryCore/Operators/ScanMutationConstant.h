/***********************************************************************\
|                                                                       |
| ScanMutationConstantOperator.h                                                |
|                                                                       |
...
#ifndef HEADER_UGP3_CORE_SCANMUTATIONDEFINEDOPERATOR
#define HEADER_UGP3_CORE_SCANMUTATIONDEFINEDOPERATOR
...
namespace ugp3
{
	namespace core
	{
        /** The Scan Mutation Operator for Defined Type/Constant Parameters. */
		class ScanMutationConstantOperator : public MutationOperator
		{
		public:
			ScanMutationConstantOperator();
				...
				- definedType
					a new individual is produced for each value that the definedType parameter can assume
    ...
    virtual Category getCategory() { return DEFAULT_OFF; }
                ...
                inline bool ScanMutationConstantOperator::hasParameters() const
                {
                  return false;
                }

                inline void ScanMutationConstantOperator::writeXml(std::ostream& output) const
                {}

                inline void ScanMutationConstantOperator::readXml(const xml::Element& element)
                {}
	}
}
